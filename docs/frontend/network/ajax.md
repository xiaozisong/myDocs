...
![image](https://cdn.jsdelivr.net/gh/qiuxchao/CDN/pictures/ajax.png)
1、客户端使用 JavaScript 通过调用一个对象 XMLHttpRequest 来请求服务器
...
当运行上面的代码并点击 button 按钮时，页面中将会新增 3 个 `ul` 和 3 个 `li` 元素并在每个 `li` 元素中显示一条数据
